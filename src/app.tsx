    ...
    <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-zinc-300 text-lg">Convide seus amigos e palneje sua próxima viagem!</p>
        </div>
        ...
        <p className="text-sm text-zinc-500 ">
          ...
          concorda <br /> com nossos <a className="text-zinc-300" href="#">termos de uso</a> e <a className="text-zinc-300" href="#">politícas de privacidade</a>.
        </p>
      </div>
              ...
              {emailsToInvite.map(email => {
                return (
                  <div key={email} className="py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2">
                    ...
                    <button type="button" onClick={() => removeEmailFromIvites(email)}>
